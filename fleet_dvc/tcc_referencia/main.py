...
ini_time = time.time()
sim_run.previous_run_static(model, model_general, model_line_type, 
                            model_vcm, object_line, object_vcm, ini_time)
...
print("\n>>>>>>>>\nAutomation's start.")
sim_run.looping(model_line_type, selection, model, stiffener_type, rt_number, 
                vessel, rl_config, buoy_set, model_vcm, object_line, 
                object_bend_restrictor, object_vcm, model_winch, model_general, 
